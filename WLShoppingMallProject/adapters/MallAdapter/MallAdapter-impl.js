...
//var selectStatement = WL.Server.createSQLStatement("select * from ITEMS ORDER BY ITEMCODE ASC");
...
//var getProductStatement = WL.Server.createSQLStatement("select * from ITEMS where ITEMCODE=?");
...
///select * from wishlist wl , items i where wl.itemcode1=i.itemcode and conid='00002';
