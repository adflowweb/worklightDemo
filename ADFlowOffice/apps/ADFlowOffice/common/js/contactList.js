...
ADF.view.ContactList = Backbone.View.extend({
	...
	initialize : function() {
		_.bindAll(this, 'render', 'loadContactList', 'loadList',
				'loadContactListSuccess','liClick'); // fixes loss of context for
		// 'this' within
		// methods
	...
	liClick : function(e) {
		...
		console.error("liClick liClick liClick");
...
//		console.log("contantDetail Item ");
//		console.log(this.collection.models[$(e.currentTarget).attr("id")]);
//		console.log("contantDetail Item2 ");
		ADF.view.contantDetail.contactSet(this.collection.models[$(e.currentTarget).attr("id")]);
